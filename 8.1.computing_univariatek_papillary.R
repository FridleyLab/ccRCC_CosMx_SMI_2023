...
#read in datas
manley_mif = readRDS("Manley_SMI/data/manual_insitutype_raw_mif/manley_mif_papillary.rds")
...
saveRDS(manley_mif2, "Manley_SMI/data/UnivariateK_mif/manley_mif_papillary.rds")
