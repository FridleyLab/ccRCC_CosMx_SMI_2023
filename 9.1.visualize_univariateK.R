...
pdf("Manley_SMI/results/figures/UnivariateRipK/tumor-stroma_tnmstage_r150_boxplot.pdf")
...
pdf("Manley_SMI/results/figures/UnivariateRipK/tumor-stroma_tnmstage_r150_scatter.pdf")
...
pdf("Manley_SMI/results/figures/UnivariateRipK/source_tnmstage_r75-150-300-500_boxplot.pdf")
tmp = lapply(marker_boxplot_tissue, print)
dev.off()
