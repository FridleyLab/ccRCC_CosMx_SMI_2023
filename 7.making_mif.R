...
saveRDS(test, "Manley_SMI/data/final_dataframes/metadata_clinical_spatial.rds")
scaled_expression = manley_data@assays$SCT@scale.data[,colnames(manley_data@assays$SCT@scale.data) %in% test$id] %>% t()
saveRDS(scaled_expression, "Manley_SMI/data/final_dataframes/sct_scaled_data.rds")
counts_expression = manley_data@assays$SCT@counts[,colnames(manley_data@assays$SCT@counts) %in% test$id] %>% SeuratDisk::Transpose()
saveRDS(counts_expression, "Manley_SMI/data/final_dataframes/sct_counts_data.rds")
...
#save raw mif
saveRDS(manley_mif, "Manley_SMI/data/manual_insitutype_raw_mif/manley_mif.rds")
